...
# 
# 851a1e25badeadd8c3714a74c5ca432a
...
url = "https://ws.audioscrobbler.com/2.0/?method=artist.search&artist=lil&limit=50&api_key=851a1e25badeadd8c3714a74c5ca432a&format=json"
...
listeners_count = 0
for artist in artists:
    listeners_count = listeners_count + int(artist["listeners"])
...
for artist in artists:
    if artist["name"] == "Lil Jon":
        print(f"Lil Jon's mbid is {artist['mbid']}.")
...
url = "https://ws.audioscrobbler.com/2.0/?method=artist.getinfo&name=liljohn&mbid=a95384b1-6aec-468c-ae0d-8c6daf87c4c2&api_key=851a1e25badeadd8c3714a74c5ca432a&format=json"
response = requests.get(url)
data_liljohn = response.json()

print(data_liljohn["artist"]["bio"]["summary"])
...
# data_liljohn["artist"]["tags"]["tag"]

for tag in data_liljohn["artist"]["tags"]["tag"]:
    print(tag["name"])
...
artist_list = data["results"]["artistmatches"]["artist"]
...
mbids = [artist["mbid"] for artist in artist_list if artist["mbid"] != ""] 
print(mbids)


# help from classmates on append.(): 
   # for url in mbids: 
...
mbid_url = "https://ws.audioscrobbler.com/2.0/?method=artist.getinfo&api_key=851a1e25badeadd8c3714a74c5ca432a&format=json&mbid="
...
mbid_url_3 = [mbid_url+mbid for mbid in mbids[:3]]
...
url = "https://ws.audioscrobbler.com/2.0/?method=artist.getinfo&api_key=851a1e25badeadd8c3714a74c5ca432a&format=json&mbid="

mbid_url_10 = [mbid_url+mbid for mbid in mbids[:10]]
